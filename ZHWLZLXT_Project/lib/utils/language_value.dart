...
class LanguageValue extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        "zh_CN": {
          ...
          Globalization.onLine: "连接正常",
          Globalization.unlink: "连接异常",
          Globalization.temperatureNormals: "温度正常",
          Globalization.kadu: "开短路异常",
          ...
          Globalization.version: "上位机软件版本",
          Globalization.version_1: "下位机软件版本",
          ...
          Globalization.connection1: "设备连接超时",
          Globalization.connection2: "正在尝试重新连接",
          Globalization.factory: "出厂设置",
          Globalization.sweep: "扫频",
          Globalization.hint: "提示",
          Globalization.loading_1: "请稍等",
          ...
          Globalization.hint_010: "请输入姓名",
          Globalization.hint_011: "请输入年龄",
          Globalization.hint_012: "请输入身份证号",
          Globalization.hint_013: "请输入住院号",
          Globalization.hint_014: "请输入床号",
          ...
          Globalization.detailsFive: '1 将电极片与电疗输出接口妥善连接。\n'
              ...
              '2.1 模式：通过调节选择连续、慢速断续输出或快速断续输出模式；\n'
              '2.2 频率：2Hz～160Hz可调，步进1Hz；\n'
              '2.3 脉宽：60us～520us可调，步进10us；\n'
              '2.4 冶疗时间：1min~30min可调，步进1min。\n'
          ...
          Globalization.detailsTwo: '1 将磁垫与脉冲磁模块输出接口妥善连接。\n'
              ...
              '3 通过“+、-”键调节频率、时间和强度。\n'
              '3.1 强度：范围0～5可调，步进1；\n'
              '3.2 频率：范围20次/min～80次/min可调，步进10次/min；\n'
              '3.3 时间：范围1min~99min可调，步进1min。\n'
          ...
          Globalization.detailsOne: "1.将超声波治疗头与超声波模块输出接口妥善连接。 \n"
              ...
              "2.1 模式：连续、断续1、断续2和断续3四种治疗模式，通过选择框选择不同的治疗模式；\n"
              "2.2 时间：范围1min~30min可调，步进1min，调节	“+、-”可以选择治疗时间，治疗时间达到设定值或手动停止时，输出停止。\n"
              "3.1 1MHz输出功率：范围0~7.2W可调，步进0.6W，启动后，根据调节“+、-”来调节输出功率大小；\n"
              "3.2 3MHz输出功率：范围0~3W可调，步进0.6W，启动后，根据调节“+、-”来调节输出功率大小。\n"
              "4.1 1MHz有效声强：范围0~1.8W/cm²可调，步进0.15W/cm²，调节输出功率时，有效声强随之变化；\n"
              "4.2 3MHz有效声强：范围0~1.5W/cm²可调，步进0.3W/cm²，调节输出功率时，有效声强随之变化。\n"
              "5 超声波治疗头未连接时，会出现“连接异常!”提示信息，识别到超声治疗头，提示“连接正常”。\n"
