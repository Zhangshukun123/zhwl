class Globalization {
  ...
  static const String Sweepfrequency = "sweep frequency"; // 断续 3
  ...
  static const String user= "User"; // 用户
  static const String times= "times"; // 次数

  static const String AttentionFour =
      "1. After the electrode pads are placed on the human body, do not operate the power switch of the treatment system, otherwise an instantaneous electric shock may occur. Before the treatment, the power switch must be turned on, and then the electrode pads must be placed on thehuman body, Remove the pads from the patient before turning off the power switch.\n"
      ...
      "3. Self-adhesive electrode pads can only be used by themselves and cannot be shared with others to avoid cross-infection; other electrode pads in contact with users should be washed withwater before and after treatment, and then use a medical cotton ball dipped in 75% medicalalcohol, use it after wiping and disinfecting the conductive surface of the electrode sheet.\n"
      "4. The electrode pads should be in close and even contact with the skin during use.\n"
      "5. The use of electrodes near the chest increases the risk of fibrillation. Avoid stimulation near the chest during treatment.\n";
