class Globalization {
  ...
  static const String AttentionFour =
      ...
      "5. The use of electrodes near the chest increases the risk of fibrillation. Avoid stimulation nearthe chest during treatment.\n";
  ...
  static const String detailsSix =
      ...
      "4. Click the icon > , \"Start Neuromuscular Therapy Channel 1\"and the intensity can be adjusted (adjustable from 0 to 99, step is 1). Please adjust the intensityslowly. During the adjustment process, keep asking the patient how they feel .\n"
  ...
  static const String detailsFour =
      ...
      "4. Click the icon > , \"Start Spasm Muscle Therapy\", the intensity(adjustable from 0 to 99, the step is 1), please adjust the intensity slowly. During the adjustmentprocess, keep asking the patient how they feel.\n"
      "5. When the set treatment time ends or the output is stopped manually, \Stop Spasm Muscle Therapy\".\n"
      "6. The icons of\"+ -\"are gray to indicate that they are not selectable.\n";
  ...
  static const String detailsThree =
      ...
      "6. In the treatment state, press the emergency stop button to stop the output, and the red words\"Emergency Stop State\" will appear on the interface. Rotate the button clockwise to 90°tocancel the emergency stop state, and the prompt information on the interface disappears.Tip: When pressing the emergency stop, the emergency stop icon will be displayed on thebutton of e# the infrared polarized light module synchronously, and it will disappear after theemergency stop state is released.\n"
